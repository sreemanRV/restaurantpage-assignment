...
class Atri:
	def __init__(self, state: Any):
		...
		self.Testimonial5 = state["Testimonial5"]
	...
	@property
	def Testimonial5(self):
		self._getter_access_tracker["Testimonial5"] = {}
		return self._Testimonial5
	@Testimonial5.setter
	def Testimonial5(self, new_state):
		self._setter_access_tracker["Testimonial5"] = {}
		global default_state
		self._Testimonial5 = Testimonial(new_state, default_state["Testimonial5"])
	...
	def _to_json_fields(self):
		return {
			...
			"Testimonial5": self._Testimonial5,
